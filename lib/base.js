        ...
        if (path.indexOf("webapps" + Path.sep + project.getProjectName() + Path.sep + "WEBINF") === -1 && path.indexOf("webapps" + Path.sep + project.getProjectName() + Path.sep + "node_modules") === -1) {
            ...
            if (suffix === "nsp") {
                ...
                if (suffix !== "") {
                    ...
                    this.getModule("fileview", {data: (path+project.getProjectConfig().getPageName("index"))}).doRender(function () {
                        goon();
                    });
                }
            }
...
Module({
    ...
    render: function (goon) {
        ...
        if (content) {
            ...
            this.getModule("stringview", {data: "page can not find."}).doRender(function () {
                ths.next();
            });
        }
    }
...
Module({
    ...
    render: function (goon) {
        ...
        this.getModule("fileview", {data: path}).doRender(function () {
