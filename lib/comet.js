...
channel.prototype._run = function () {
    var a = this.reader.shift();
    if (a) {
        a.resolve(this.msg.shift() || {type: "nodata"});
    }
};
...
Module({
    ...
    start: function (done) {
        this.option.checktime = this.option.keeptime + this.option.keeptime / 2;
        this.channels = {};
